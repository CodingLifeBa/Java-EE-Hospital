...
public class ArchiverSP {

	private int numDossier;
	private String codePatient,examen,dateExamen,resultat,dateResultat,matriculeMed;
	
	
	public ArchiverSP (int numDossier, String codePatient, String examen, String dateExamen, String resultat,
	...
	public ArchiverSP(String codePatient, String examen, String dateExamen, String resultat, String dateResultat,
			String matriculeMed) {
		super();
		this.codePatient = codePatient;
		this.examen = examen;
